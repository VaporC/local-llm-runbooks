...
- **稠密模型吃显存带宽**(专业独显优势最大),**MoE 稀疏模型能大而不慢**(核显也能跑得动)——选型先看这条;
...
*免责:文中涉及的部分模型为社区第三方量化 / 改版,请自行判断来源与用途合规性。所有配置为作者实测环境,换硬件/版本可能需调整。测评数据为实机测得,测试方法详见各篇说明。*
